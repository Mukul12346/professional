<section class="product footer" style=" background-color:#000000;">
    <div class="container">
            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-order">
                        <div class="logo">
                            <img src="web_assets/images/logos/logo.png" alt="logo" style="width:200px;">
                        </div>
                        <div class="footer-link order-link">
                            <p>The Super Life, also known as Ayurveda, is based on ancient writings that rely on a “natural” and holistic approach to physical and mental health.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
        ...
        <hr>
        <p class="text-center">© Copyright 2024 superlife.cloud. All Rights Reserved.</p>
    </div>
</section>


<script src="web_assets/js/jquery_3.7.1.min.js"></script>

<script src="web_assets/js/bootstrap_5.3.2.bundle.min.js"></script>

<script src="web_assets/js/nouislider.min.js"></script>

<script src="web_assets/js/aos-3.0.0.js"></script>

<script src="web_assets/js/swiper10-bundle.min.js"></script>

<script src="web_assets/js/shopus.js"></script>
</body>
